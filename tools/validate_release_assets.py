"""Static release-asset validation for the Pix2Struct TextCaps DIMER pipeline.
...
EXPECTED_OUTPUTS = (
    ...
    "outputs/pix2struct_textcaps_annotated.png",
)
